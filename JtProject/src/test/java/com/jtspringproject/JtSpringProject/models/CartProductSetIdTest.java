...
public class CartProductSetIdTest {
    @Test
    public void setIdWithValidValue() {
        ...
        int validId = 123;
        // Act
        cartProduct.setId(validId);
        // Assert
        assertEquals(validId, cartProduct.getId(), "The ID of the object should be set to the provided value.");
    }
    @Test
    public void setIdWithNegativeValue() {
        ...
        int negativeId = -123;
        // Act and Assert
        // If the setId method does not validate the id value, it should be updated to throw IllegalArgumentException for negative values.
        assertThrows(IllegalArgumentException.class, () -> cartProduct.setId(negativeId), "The method should throw an exception when trying to set a negative ID.");
    }
    @Test
    public void setIdWithZeroValue() {
        ...
        int zeroId = 0;
        // Act and Assert
        // If the setId method does not validate the id value, it should be updated to throw IllegalArgumentException for zero value.
        assertThrows(IllegalArgumentException.class, () -> cartProduct.setId(zeroId), "The method should throw an exception when trying to set an ID to zero.");
    }
}
